...
<Project Type="Project" LVVersion="21008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Main_App" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="Test_State_Block_Chain.vi" Type="VI" URL="../Test_State_Block_Chain.vi"/>
			<Item Name="Testing_Original.vi" Type="VI" URL="../Testing_Original.vi"/>
		</Item>
		<Item Name="Panel_Parent_Class" Type="Folder">
			<Item Name="SSW_Panel_Adaptive.lvlibp" Type="LVLibp" URL="/C/Program Files (x86)/Hyper State Machine Framework/SSW_Panel_Adaptive.lvlibp">
				<Item Name="Command to State Elements.vi" Type="VI" URL="/C/Program Files (x86)/Hyper State Machine Framework/SSW_Panel_Adaptive.lvlibp/Files_Module/Command to State Elements.vi"/>
				<Item Name="Create_DVR_Ref.vi" Type="VI" URL="/C/Program Files (x86)/Hyper State Machine Framework/SSW_Panel_Adaptive.lvlibp/Panel_Adaptive/Hyper_Panel_State_Machine.llb/Create_DVR_Ref.vi"/>
				<Item Name="Error Cluster From Error Code.vi" Type="VI" URL="/C/Program Files (x86)/Hyper State Machine Framework/SSW_Panel_Adaptive.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Error Cluster From Error Code.vi"/>
				<Item Name="Get_DVR_Ref.vi" Type="VI" URL="/C/Program Files (x86)/Hyper State Machine Framework/SSW_Panel_Adaptive.lvlibp/Panel_Adaptive/Hyper_Panel_State_Machine.llb/Get_DVR_Ref.vi"/>
				<Item Name="Member VI Info.ctl" Type="VI" URL="/C/Program Files (x86)/Hyper State Machine Framework/SSW_Panel_Adaptive.lvlibp/1abvi3w/vi.lib/Utility/Data Type/Member VI Info.ctl"/>
				<Item Name="NI_Data Type.lvlib" Type="Library" URL="/C/Program Files (x86)/Hyper State Machine Framework/SSW_Panel_Adaptive.lvlibp/1abvi3w/vi.lib/Utility/Data Type/NI_Data Type.lvlib"/>
				<Item Name="Panel_Adaptive.lvclass" Type="LVClass" URL="/C/Program Files (x86)/Hyper State Machine Framework/SSW_Panel_Adaptive.lvlibp/Panel_Adaptive/Panel_Adaptive.lvclass"/>
				<Item Name="Panel_Get_HSMO_Index.vi" Type="VI" URL="/C/Program Files (x86)/Hyper State Machine Framework/SSW_Panel_Adaptive.lvlibp/Panel_Adaptive/Hyper_Panel_State_Machine.llb/Panel_Get_HSMO_Index.vi"/>
				<Item Name="Panel_Interface.lvclass" Type="LVClass" URL="/C/Program Files (x86)/Hyper State Machine Framework/SSW_Panel_Adaptive.lvlibp/Panel_Interface/Panel_Interface.lvclass"/>
			</Item>
		</Item>
		<Item Name="Panel_Derived_Class" Type="Folder">
			<Item Name="DIO_Panel_State_Machine.lvclass" Type="LVClass" URL="../DIO_Panel_State_Machine/DIO_Panel_State_Machine.lvclass"/>
			<Item Name="Motion_Panel_State_Machine.lvclass" Type="LVClass" URL="../Motion_Panel_State_Machine/Motion_Panel_State_Machine.lvclass"/>
			<Item Name="Machine_Vision.lvclass" Type="LVClass" URL="../Machine_Vision/Machine_Vision.lvclass"/>
		</Item>
		<Item Name="Panel_Implementation" Type="Folder">
			<Item Name="Panel1.lvclass" Type="LVClass" URL="../Class 1/Panel1.lvclass"/>
			<Item Name="Panel2.lvclass" Type="LVClass" URL="../Class 2/Panel2.lvclass"/>
			<Item Name="Panel3.lvclass" Type="LVClass" URL="../Class 3/Panel3.lvclass"/>
		</Item>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Command to State Elements.vi" Type="VI" URL="../../Files_Module/Command to State Elements.vi"/>
			...
			<Item Name="Sample_Panel_1.vi" Type="VI" URL="../Sample UI/Sample_Panel_1.vi"/>
			<Item Name="Sample_Panel_2.vi" Type="VI" URL="../Sample UI/Sample_Panel_2.vi"/>
			<Item Name="Sample_Panel_3.vi" Type="VI" URL="../Sample UI/Sample_Panel_3.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="State_Block_Chain_Testing" Type="EXE">
				<Property Name="App_copyErrors" Type="Bool">true</Property>
				<Property Name="App_INI_aliasGUID" Type="Str">{74EA335C-9B99-4617-85C6-1C17075D0D45}</Property>
				<Property Name="App_INI_GUID" Type="Str">{57D80E1E-76E8-4FD5-8926-68B77822B136}</Property>
				<Property Name="App_serverConfig.httpPort" Type="Int">8002</Property>
				<Property Name="App_serverType" Type="Int">0</Property>
				<Property Name="Bld_buildCacheID" Type="Str">{3D30C466-680A-499B-9487-5DA5FA022EE8}</Property>
				<Property Name="Bld_buildSpecDescription" Type="Str">State_Block_Chain_Testing</Property>
				<Property Name="Bld_buildSpecName" Type="Str">State_Block_Chain_Testing</Property>
				...
				<Property Name="Bld_previewCacheID" Type="Str">{B4543463-8B5C-47C1-8A9F-BC3457092FB6}</Property>
				<Property Name="Bld_supportedLanguage[0]" Type="Str">English</Property>
				<Property Name="Bld_supportedLanguageCount" Type="Int">1</Property>
				<Property Name="Bld_version.major" Type="Int">1</Property>
				<Property Name="Destination[0].destName" Type="Str">State_Block_Chain_Testing.exe</Property>
				<Property Name="Destination[0].path" Type="Path">../Builds/State_Block_Chain_Testing.exe</Property>
				...
				<Property Name="Destination[2].destName" Type="Str">Modules</Property>
				<Property Name="Destination[2].path" Type="Path">../Builds/Modules</Property>
				<Property Name="Destination[2].path.type" Type="Str">relativeToProject</Property>
				<Property Name="DestinationCount" Type="Int">3</Property>
				<Property Name="Source[0].itemID" Type="Str">{A4BB969B-0044-4C42-AE62-0C424B6519DC}</Property>
				<Property Name="Source[0].type" Type="Str">Container</Property>
				<Property Name="Source[1].destinationIndex" Type="Int">0</Property>
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/Main_App/Test_State_Block_Chain.vi</Property>
				...
				<Property Name="Source[2].itemID" Type="Ref">/My Computer/Panel_Implementation</Property>
				<Property Name="Source[2].sourceInclusion" Type="Str">Include</Property>
				<Property Name="Source[2].type" Type="Str">Container</Property>
				<Property Name="SourceCount" Type="Int">3</Property>
				<Property Name="TgtF_fileDescription" Type="Str">State_Block_Chain_Testing</Property>
				<Property Name="TgtF_internalName" Type="Str">State_Block_Chain_Testing</Property>
				<Property Name="TgtF_legalCopyright" Type="Str">Copyright © 2025 </Property>
				<Property Name="TgtF_productName" Type="Str">State_Block_Chain_Testing</Property>
				<Property Name="TgtF_targetfileGUID" Type="Str">{93C96608-1DE8-4E4A-B639-B38928565386}</Property>
				<Property Name="TgtF_targetfileName" Type="Str">State_Block_Chain_Testing.exe</Property>
